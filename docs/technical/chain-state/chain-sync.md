...
> *Read (part of) this in other languages: [Korean](chain_sync_KR.md).* </br>
> *Read about fast sync in other languages: [Español](fast-sync_ES.md), [Korean](fast-sync_KR.md), [简体中文](fast-sync_ZH-CN.md).*
